...
namespace Famcare\ZatcaInvoicing\XML;
...
class XMLGenerator
{
     ...
     * @return self
     * @throws \Famcare\ZatcaInvoicing\Exceptions\ZatcaStorageException If the XML file cannot be saved.
     */
    public function saveXMLFile(string $filename = 'unsigned_invoice.xml', ?string $outputDir = 'output'): self
    {
        (new \Famcare\ZatcaInvoicing\Helpers\Storage($outputDir))->put($filename, $this->generatedXml);
        return $this;
    }
}