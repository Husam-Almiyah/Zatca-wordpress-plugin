...
class Storage
{
    ...
    /**
     * Static helper to write to a file within a directory.
     */
    public static function putTo(string $directory, string $filename, string $content): bool
    {
        $instance = new self($directory);
        return $instance->put($filename, $content);
    }
