...
class TaxCategory implements XmlSerializable
{
    ...
    public function xmlSerialize(Writer $writer): void
    {
        ...
        // Write percent; retain decimals as per EN16931, but integer for standard KSA rates still valid
        $writer->write([
            Schema::CBC . 'Percent' => rtrim(rtrim(number_format($this->percent, 2, '.', ''), '0'), '.'),
        ]);
