<?php
namespace Famcare\ZatcaInvoicing\Models;

use DateTime;
use InvalidArgumentException;
use Sabre\Xml\Writer;
use Sabre\Xml\XmlSerializable;
use Famcare\ZatcaInvoicing\Schema;
...
class Invoice implements XmlSerializable
{
    ...
    /** @var TaxTotal[]|null Array of tax totals for ZATCA compliance. */
    private ?array $taxTotals = null;
    ...
    /**
     * Set multiple tax totals for ZATCA compliance.
     *
    ...
    public function xmlSerialize(Writer $writer): void
    {
        ...
        // TaxTotal(s) - Support multiple TaxTotals for ZATCA compliance
        if ($this->taxTotals !== null) {
            // Write multiple TaxTotal elements for ZATCA compliance
            foreach ($this->taxTotals as $taxTotal) {
                $writer->write([Schema::CAC . 'TaxTotal' => $taxTotal]);
            }
        } elseif ($this->taxTotal !== null) {
            // Write a single TaxTotal element using the model to include breakdown
